...
class DataRowsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $dataRow = $this->dataRow($postsDataType, 'user_id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'hidden',
        ...
        $dataRow = $this->dataRow($postsDataType, 'post_content');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $dataRow = $this->dataRow($postsDataType, 'post_title');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $dataRow = $this->dataRow($postsDataType, 'post_status');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $dataRow = $this->dataRow($postsDataType, 'post_name');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $dataRow = $this->dataRow($postsDataType, 'post_type');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $dataRow = $this->dataRow($postsDataType, 'post_category');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $dataRow = $this->dataRow($postsDataType, 'image_file');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'image',
        ...
        $dataRow = $this->dataRow($commentsDataType, 'commenter_id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'hidden',
                'display_name' => 'Commenter Id',
                'required'     => 0,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
        ...
        $dataRow = $this->dataRow($commentsDataType, 'commenter_type');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'hidden',
                'display_name' => 'Commenter Type',
                'required'     => 0,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
        ...
        $dataRow = $this->dataRow($commentsDataType, 'guest_name');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $dataRow = $this->dataRow($commentsDataType, 'guest_email');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $dataRow = $this->dataRow($commentsDataType, 'commentable_type');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'hidden',
        ...
        $dataRow = $this->dataRow($commentsDataType, 'commentable_id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $dataRow = $this->dataRow($commentsDataType, 'approved');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $dataRow = $this->dataRow($commentsDataType, 'child_id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $contactsDataType = DataType::where('slug', 'contacts')->firstOrFail();

        $dataRow = $this->dataRow($contactsDataType, 'id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'number',
                'display_name' => 'ID',
        ...
        $dataRow = $this->dataRow($contactsDataType, 'contact_name');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $dataRow = $this->dataRow($contactsDataType, 'contact_email');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $dataRow = $this->dataRow($contactsDataType, 'contact_message');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Contact Message',
                'required'     => 1,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
        ...
        $dataRow = $this->dataRow($contactsDataType, 'created_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'hidden',
                'display_name' => 'Created At',
        ...
        $dataRow = $this->dataRow($contactsDataType, 'updated_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'hidden',
                'display_name' => 'Updated At',
        ...
        $newslettersDataType = DataType::where('slug', 'newsletters')->firstOrFail();

        $dataRow = $this->dataRow($newslettersDataType, 'id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'number',
                'display_name' => 'ID',
        ...
        $dataRow = $this->dataRow($newslettersDataType, 'newsletters_email');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Newsletters Email',
                'required'     => 1,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
        ...
        $dataRow = $this->dataRow($newslettersDataType, 'created_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'hidden',
                'display_name' => 'Created At',
        ...
        $dataRow = $this->dataRow($newslettersDataType, 'updated_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'hidden',
                'display_name' => 'Updated At',
